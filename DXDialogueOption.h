...
public:
	...
	static void SetGlobalColours(int colour1, int colour2, int colour3, int colour4) { _textColour1 = colour1; _textColour2 = colour2; _textColour3 = colour3; _textColour4 = colour4; };
