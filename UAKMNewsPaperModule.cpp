...
void CUAKMNewsPaperModule::Initialize()
{
	_display = 1;
	_highLight = 0;
...
void CUAKMNewsPaperModule::Dispose()
{
...
void CUAKMNewsPaperModule::Resize(int width, int height)
{
}
...
void CUAKMNewsPaperModule::Back()
{
	if (_display == NEWSPAPER_PAGE)
	{
