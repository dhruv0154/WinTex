...
public:
    ...
    static void SetItemName(int id, const std::string& text);
...
protected:
    ...
    public:
        ...
        void SetItemName(const std::string& text) { Text.SetTextUnmodified(text.c_str()); }
        void ResetText();

    protected:
        int Id{0};
        ID3D11Buffer* ImageBuffer{nullptr}; // Using global image texture
        CDXText Text;
    };
